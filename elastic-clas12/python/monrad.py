...
if __name__ == '__main__':
    ...
    plot_sector_page(can, histos, 'w_CTOF_{}', lab, save_name=output_pdfname,
                     title='(CTOF)', xtitle='W')
    
    plot_sector_page(can, histos, 'w_FTOF_{}', lab, save_name=output_pdfname,
                     title='(FTOF)', xtitle='W')

    plot_sector_page(can, histos, 'w_pass_angle_CTOF_{}', lab, save_name=output_pdfname,
                     title='Pass #Delta #phi Cut (CTOF)', xtitle='W')
    
    plot_sector_page(can, histos, 'w_pass_angle_FTOF_{}', lab, save_name=output_pdfname,
                     title='Pass #Delta #phi Cut (FTOF)', xtitle='W')

    plot_sector_page(can, histos, 'w_pass_all_CTOF_{}', lab, save_name=output_pdfname,
                     title='Pass All (CTOF)', xtitle='W')
    
    plot_sector_page(can, histos, 'w_pass_all_FTOF_{}', lab, save_name=output_pdfname,
                     title='Pass All (FTOF)', xtitle='W')

    #    add_text_page(can, lab, text='Event Selection', save_name=output_pdfname)
    
    plot_sector_page(can, histos, 'angle_ep_CTOF_{}', lab, save_name=output_pdfname,
                     title='Electron (Forward), Proton (CTOF)', xtitle='#phi_{ep}')
    
    plot_sector_page(can, histos, 'angle_ep_FTOF_{}', lab, save_name=output_pdfname,
                     title='Electron (Forward), Proton (FTOF)', xtitle='#phi_{ep}')

    plot_sector_page(can, histos, 'angle_ep_pass_theta_gamma_CTOF_{}', lab, save_name=output_pdfname,
                     title='(CTOF)  Pass #theta_{gamma}', xtitle='#phi_{ep}')
    
    plot_sector_page(can, histos, 'angle_ep_pass_theta_gamma_FTOF_{}', lab, save_name=output_pdfname,
                     title='(FTOF) Pass #theta_{gamma}', xtitle='#phi_{ep}')

    plot_sector_page(can, histos, 'theta_gamma_CTOF_{}', lab, save_name=output_pdfname,
                     title='Electron (Forward), Proton (CTOF)', xtitle='#theta_{#gamma}')
    
    plot_sector_page(can, histos, 'theta_gamma_FTOF_{}', lab, save_name=output_pdfname,
                     title='Electron (Forward), Proton (FTOF)', xtitle='#theta_{#gamma}')
    
    plot_sector_page(can, histos, 'theta_gamma_pass_angle_CTOF_{}', lab, save_name=output_pdfname,
                     title='Pass #Delta #phi (CTOF)', xtitle='#theta_{#gamma}')
     
    plot_sector_page(can, histos, 'theta_gamma_pass_angle_FTOF_{}', lab, save_name=output_pdfname,
                     title='Pass #Delta #phi (FTOF)', xtitle='#theta_{#gamma}')

    plot_sector_page(can, histos, 'p_ele_theta_ele_CTOF_{}', lab, save_name=output_pdfname,
                     title='(CTOF)', xtitle='p_{e}', ytitle='#theta_{e}', log=True)

    plot_sector_page(can, histos, 'p_ele_theta_ele_FTOF_{}', lab, save_name=output_pdfname,
                     title='(FTOF)', xtitle='p_{e}', ytitle='#theta_{e}', log=True)

    plot_sector_page(can, histos, 'p_pro_theta_pro_CTOF_{}', lab, save_name=output_pdfname,
                     title='(CTOF)', xtitle='p_{p}', ytitle='#theta_{p}', log=True)
 
    plot_sector_page(can, histos, 'p_pro_theta_pro_FTOF_{}', lab, save_name=output_pdfname,
                     title='(FTOF)', xtitle='p_{p}', ytitle='#theta_{p}', log=True)
 
    plot_sector_page(can, histos, 'theta_e_theta_gamma_pass_angle_CTOF_{}', lab, save_name=output_pdfname,
                     title='(CTOF)', xtitle='#theta_{e}', ytitle='#theta_{#gamma}', log=True)

    plot_sector_page(can, histos, 'theta_e_theta_gamma_pass_angle_FTOF_{}', lab, save_name=output_pdfname,
                     title='(FTOF)', xtitle='#theta_{e}', ytitle='#theta_{#gamma}', log=True)

    add_text_page(can, lab, text='Resolutions', save_name=output_pdfname)

    plot_sector_page(can, histos, 'p_ele_dp_ele_CTOF_{}', lab, save_name=output_pdfname,
    ...
    plot_sector_page(can, histos, 'p_ele_dp_ele_FTOF_{}', lab, save_name=output_pdfname,
    ...
    plot_sector_page(can, histos, 'p_pro_dp_pro_CTOF_{}', lab, save_name=output_pdfname,
    ...
    plot_sector_page(can, histos, 'p_pro_dp_pro_FTOF_{}', lab, save_name=output_pdfname,
    ...
    plot_sector_page(can, histos, 'theta_ele_dtheta_ele_CTOF_{}', lab, save_name=output_pdfname,
                     title='#Theta Resolution (CTOF)', xtitle='#theta_{e}', ytitle='#Delta #theta_{e}',
                     log=True)

    plot_sector_page(can, histos, 'theta_ele_dtheta_ele_FTOF_{}', lab, save_name=output_pdfname,
                     title='#Theta Resolution (FTOF)', xtitle='#theta_{e}', ytitle='#Delta #theta_{e}',
                     log=True)

    plot_sector_page(can, histos, 'theta_pro_dtheta_pro_CTOF_{}', lab, save_name=output_pdfname,
                     title='#Theta Resolution (CTOF)', xtitle='#theta_{p}', ytitle='#Delta #theta_{p}',
                     log=True)

    plot_sector_page(can, histos, 'theta_pro_dtheta_pro_FTOF_{}', lab, save_name=output_pdfname,
    ...
    """
    plot_sector_page(lcan, histos, 'p_ele_dp_ele_from_angles_CTOF_{}', lab,
    ...
    plot_sector_page(lcan, histos, 'p_pro_dp_pro_from_angles_CTOF_{}', lab,
